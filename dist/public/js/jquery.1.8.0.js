...
(function (window, undefined) {
		...
		Deferred: function Deferred(func) {
			...
			["resolve", "done", jQuery.Callbacks("once memory"), "resolved"], ["reject", "fail", jQuery.Callbacks("once memory"), "rejected"], ["notify", "progress", jQuery.Callbacks("memory")]],
				...
				promise: function promise(obj) {
					return (typeof obj === "undefined" ? "undefined" : _typeof(obj)) === "object" ? jQuery.extend(obj, _promise) : _promise;
				}
			},
			    deferred = {};
  ...
  */
	(function (window, undefined) {
		...
		createInputFunction = function createInputFunction(type) {
		...
		createButtonFunction = function createButtonFunction(type) {
			return function (elem) {
   ...
   */
		...
		var select = function select(selector, context, results, seed, xml) {
